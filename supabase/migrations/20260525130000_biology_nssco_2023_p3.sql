-- ===========================================================================
-- NSSCO Biology 2023 Paper 3 (6116/3) — Alt to Practical, 4 questions, 23 sub-parts, 40 marks
-- Verbatim NIED wording from past-papers/nssco-biology/2023/
-- Expected answers + commentary from DNEA Examiners Report 2023 (pages 58-61)
-- Diagrams: public/past-papers/biology-nssco-2023-p3/*.png
-- ===========================================================================
...
begin
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '1(a)', 3, 'paid',
    'free_text',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(a)** Plot **line graphs** of both sets of data in Table 1.1 on a grid (time on the x-axis, rate on the y-axis up to 8 g/hour). Describe the plotting choices you would make:\n\n• How would you mark and distinguish the two sets of points (key)?\n• How would you join the points?\n• Where would your y-axis scale start and end and what increments would you use?',
    null,
    E'All 3 marks required:\nP — All points plotted correctly (both lines);\nL — Plotted points joined with RULED LINES (not free-hand or extrapolated past the data);\nK — Correct KEY clearly distinguishing the two sets (different symbols or labelled lines);\n\n**Examiner commentary:** The majority gave a correct KEY but couldn''t provide correct plots. Plotted points weren''t joined with a ruled line. Huge dots/crosses covered up to 2 small squares. Extrapolation past the data was common, costing the L mark.',
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '1(b)(i)', 1, 'free',
    'fill_in',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(b)(i)** Estimate the time of sunrise on that day.',
    null,
    jsonb_build_object(
      ...
      '04:00',
        ...
        '06:00',
        'around 06:00',
        '06:00 (any time 04:00-06:00)',
        '4-6 am',
        'between 04:00 and 06:00'
    )
    ),
    false,
    E'Any time from 04:00 up to 06:00; [1 mark]\n\n**Examiner commentary:** The majority could not give the time of sunrise. Those who got the correct time often lost the explanation mark by failing to connect stomata opening to light.',
    E'Sunrise is when light first reaches the plant. Two clues from the table:\n• Transpiration starts to **rise sharply** between 04:00 (0.3) and 08:00 (2.0)\n• Transpiration rises when light triggers the **stomata to open** → water vapour escapes faster\n\nSo sunrise must be between 04:00 and 06:00 (any time in that range is accepted).',
    true
  );

  -- ─── Q1(b)(ii)  [1 mark, paid, free_text] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, memo, rubric, explanation, is_published
  ) values (
    bio_id, 2023, '3', '1(b)(ii)', 1, 'paid',
    'free_text',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(b)(ii)** Explain your answer in (b)(i) using information on the graph.',
    null,
    E'Transpiration suddenly rises + as the stomata open in the light; [1 mark — BOTH halves needed]\n\n**Examiner commentary:** Candidates who got the correct sunrise time still lost this mark because they only said ''transpiration suddenly rises'' without linking it to stomata opening when light hits the leaves.',
    E'Award 1 mark for explaining BOTH: (a) transpiration suddenly rises on the graph AND (b) because stomata open in response to LIGHT (sunrise). PENALISE answers that only mention the rise without linking to stomata + light.',
  ...
  -- ─── Q1(c)(i)  [1 mark, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '1(c)(i)', 1, 'free',
    'fill_in',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(c)(i)** For how long during the day had the water loss remained **greater than** water absorption?',
    null,
    jsonb_build_object(
      'accepted', jsonb_build_array(
      '8 hours',
...
, 'must_contain', jsonb_build_array('hour')
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '1(c)(ii)', 1, 'free',
    'fill_in',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(c)(ii)** Suggest what could be done to provide a better balance between water absorption and water loss from the plant.',
    null,
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'supply more water',
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '1(d)(ii)', 1, 'free',
    'fill_in',
    E'A Grade 11 learner carried out an investigation to compare the rate of transpiration with the rate of water absorption in a plant.\n\nThe learner took the readings at four hour intervals during a twenty-four hour period when there was little wind.\n\n**Table 1.1**\n\n| time | rate of water absorption / g per hour | rate of transpiration / g per hour |\n|---|---|---|\n| 00:00 | 2.0 | 0.5 |\n| 04:00 | 1.5 | 0.3 |\n| 08:00 | 1.5 | 2.0 |\n| 12:00 | 3.5 | 5.0 |\n| 16:00 | 5.6 | 7.3 |\n| 20:00 | 3.4 | 0.9 |\n| 24:00 | 2.0 | 0.5 |\n\n**(d)(ii)** Suggest a reason why absorption starts to **fall** again after 16:00.',
    null,
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'transpiration decreases',
        ...
        'less transpiration',
        'lower transpiration',
        'no need for more absorption'
    )
, 'must_contain', jsonb_build_array('transpiration')
    ),
    false,
    E'Transpiration decreases (no need for more absorption); [1 mark]\n\n**Examiner commentary:** To suggest a reason why absorption falls after 16:00 seemed very difficult for the candidates.',
    E'After 16:00, the sun goes down → light decreases → **stomata begin to close** → **transpiration falls** (look at the table: 7.3 g/hr at 16:00 → 0.9 g/hr at 20:00).\n\nWith less water being lost, the plant doesn''t need to absorb as much — so absorption falls back too. The whole cycle reverses.',
    true
  );

  -- ─── Q2(a)(i)  [2 marks, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '2(a)(i)', 2, 'free',
    'fill_in',
    E'The plant growth hormone **auxin** is involved in tropic responses in plants such as gravitropism.\n\nA Grade 11 learner investigated the length of the roots from maize seedlings grown at different concentrations of auxins. The root length of four seedlings were measured. Results in **Table 2.1**.\n\n| % auxin | root 1 / mm | root 2 / mm | root 3 / mm | root 4 / mm | average / mm |\n|---|---|---|---|---|---|\n| 0.0 | 15 | 18 | 14 | 15 | 15.5 |\n| 0.2 | 18 | 19 | 20 | 18 | 18.8 |\n| 0.4 | 24 | 22 | 22 | 23 | 22.8 |\n| 0.6 | 17 | 18 | 17 | 19 | ?  |\n| 0.8 | 13 | 14 |  5 | 12 | 13.0 |\n| 1.0 | 12 | 10 | 12 | 11 | 11.3 |\n\n**(a)(i)** Calculate the average root length at the concentration of **0.6 %**. Show your working and give your answer to **one decimal place**.',
    null,
    jsonb_build_object(
      'accepted', jsonb_build_array(
      '17.8',
        ...
        '71/4 = 17.8',
        '17.75',
        '17.75 rounded to 17.8'
    )
, 'must_contain', jsonb_build_array('17.8')
    ),
    false,
    E'Working: (17 + 18 + 17 + 19) ÷ 4 = 71/4 = **17.8 mm**; [2 marks — 1 for correct working, 1 for correct answer to 1 d.p.]\n\n**Examiner commentary:** Well answered, although many candidates failed to write the answer in the Table as instructed.',
    E'**Mean = sum of values ÷ count.**\n\nAt 0.6 %: 17 + 18 + 17 + 19 = 71\n\nMean = 71 ÷ 4 = **17.75 mm** → rounded to **17.8 mm** (1 d.p.)\n\nShow:\n• The full addition\n• The division\n• The final number to the EXACT decimal places the question asks for',
    true
  );

  -- ─── Q2(a)(ii)  [1 mark, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '2(a)(ii)', 1, 'free',
    'fill_in',
    E'The plant growth hormone **auxin** is involved in tropic responses in plants such as gravitropism.\n\nA Grade 11 learner investigated the length of the roots from maize seedlings grown at different concentrations of auxins. The root length of four seedlings were measured. Results in **Table 2.1**.\n\n| % auxin | root 1 / mm | root 2 / mm | root 3 / mm | root 4 / mm | average / mm |\n|---|---|---|---|---|---|\n| 0.0 | 15 | 18 | 14 | 15 | 15.5 |\n| 0.2 | 18 | 19 | 20 | 18 | 18.8 |\n| 0.4 | 24 | 22 | 22 | 23 | 22.8 |\n| 0.6 | 17 | 18 | 17 | 19 | ?  |\n| 0.8 | 13 | 14 |  5 | 12 | 13.0 |\n| 1.0 | 12 | 10 | 12 | 11 | 11.3 |\n\n**(a)(ii)** Identify **one** anomalous data value in Table 2.1.',
    null,
    jsonb_build_object(
      'accepted', jsonb_build_array(
      '5',
        '5 in column 3 row 0.8',
        '5 (at 0.8% concentration)',
        'the 5 at 0.8 percent',
        '5mm in row 0.8'
    )
, 'must_contain', jsonb_build_array('5')
    ),
    false,
    E'Encircle the **5** in the row for 0.8 % concentration (root 3 column); [1 mark]\n\n**Examiner commentary:** Quite a number of candidates could not identify the anomalous data. Anomalous data is an observation that deviates significantly from the rest of the data set.',
    E'**Anomaly** = a value that doesn''t fit the pattern of the rest of the data.\n\nLook at the 0.8 % row: 13, 14, **5**, 12 — three of these are around 12–14 mm, but one is **5 mm**. That''s the anomaly — way too low compared to its siblings, and it doesn''t match the trend of the other concentrations either.\n\nIn an exam, draw a clear circle around it.',
    true
  );
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '2(c)(i)', 1, 'free',
    'fill_in',
    E'Fig. 2.2 shows the root tip of a maize seedling. R and S mark the ends of a line across the tip.\n\n**(c)(i)** Measure the length of line **RS** on Fig. 2.2. Give your answer with units.',
    '/past-papers/biology-nssco-2023-p3/root-tip.png',
    jsonb_build_object(
      'accepted', jsonb_build_array(
      '15 mm',
        '16 mm',
...
, 'must_contain', jsonb_build_array('mm')
    ),
    false,
    E'Any of: 15 mm / 16 mm / 17 mm (or 1.5 cm / 1.6 cm / 1.7 cm); [1 mark — unit required]\n\n**Examiner commentary:** Perceived as a give-away but about half of candidates lost the mark. Many couldn''t read the scale of a ruler in millimetres. Candidates must indicate the units used.',
    E'**How to measure correctly:**\n1. Line up your ruler so the ''0'' is exactly on point R\n2. Read where the ruler crosses point S\n3. Use **mm** (millimetres) unless the question says otherwise — they''re the standard for biological drawings\n4. Always include the **unit** — ''15'' loses the mark, ''15 mm'' gets it\n\nThe accepted answer range is 15–17 mm because the image can be printed at slightly different sizes; examiners allow a small tolerance.',
    true
  );

  -- ─── Q2(c)(ii)  [3 marks, paid, free_text] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, memo, rubric, explanation, is_published
  ) values (
    bio_id, 2023, '3', '2(c)(ii)', 3, 'paid',
    'free_text',
    E'Fig. 2.2 shows the root tip of a maize seedling. The actual length of the image along line RS is 280 μm.\n\n**(c)(ii)** Calculate the **magnification** of the root tip at RS. Show your working, including the formula used.',
    '/past-papers/biology-nssco-2023-p3/root-tip.png',
    E'All 3 marks required:\n1. Unit conversion: 280 μm = 0.28 mm (or 15 mm = 15000 μm);\n2. Formula stated: magnification = size of image ÷ actual size;\n3. Correct calculation: e.g. 15 mm ÷ 0.28 mm = ×53.6 (or ×57.1 if measured 16 mm; ×60.7 if measured 17 mm);\n\n**Examiner commentary:** Most recalled the formula but substituted wrongly. Common errors: missing × sign; units attached to magnification (×53.6 mm — WRONG); wrong rounding. Some candidates didn''t convert units to the same scale before dividing — biggest single cause of lost marks.',
    E'Award 3 marks: (1) unit conversion so both values are in the same unit; (2) formula ''magnification = image size ÷ actual size'' explicitly written; (3) correct calculation with multiplication sign (×) and NO units (magnification has no units). PENALISE: missing × sign; units (mm, cm) attached to magnification; wrong rounding.',
    E'**Three steps to a magnification calculation:**\n\n1. **Convert** both lengths to the SAME unit:\n   • 280 μm ÷ 1000 = **0.28 mm**\n   *(or 15 mm × 1000 = 15 000 μm)*\n\n2. **Formula**: \n   `magnification = image size ÷ actual size`\n\n3. **Calculation** (if you measured 15 mm):\n   • magnification = 15 mm ÷ 0.28 mm\n   • = **×53.6** (or ×57.1 for 16 mm; ×60.7 for 17 mm)\n\n**Crucial:** magnification has **NO UNITS** — write ''×53.6'', never ''53.6 mm''. The × sign is REQUIRED.',
    true
  );
  ...
  insert into public.past_paper_questions (
    ...
    bio_id, 2023, '3', '3(a)(i)', 1, 'free',
    'fill_in',
    E'Fig. 3.1 shows the apparatus used to investigate **anaerobic respiration** in yeast. The setup uses yeast in glucose solution with an oil layer on top, connected to a tube of lime water.\n\n**(a)(i)** Give a reason why all equipment is **sterilised** when setting up the apparatus.',
    '/past-papers/biology-nssco-2023-p3/yeast-apparatus.png',
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'to kill respiring microorganisms',
        'kill microorganisms',
        'kill bacteria',
        'kill other microorganisms that respire',
        'to kill other organisms'
    )
, 'must_contain', jsonb_build_array('kill')
    ),
    false,
    E'To kill (other) respiring microorganisms; [1 mark]\n\n**Examiner commentary:** Many centres failed to introduce this investigation to the candidates — responses showed unfamiliarity with the apparatus.',
    E'Sterilising the equipment **kills other microorganisms** (bacteria, fungi, other yeasts) that might be on the glassware.\n\nIf you don''t sterilise:\n• Other microbes also respire → produce CO₂ → confounds your results\n• You can''t tell if the bubbles came from YOUR yeast or from contaminants\n\nSterilising removes the contaminants so any CO₂ produced is definitely from the yeast you added.',
    true
  );

  -- ─── Q3(a)(ii)  [1 mark, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '3(a)(ii)', 1, 'free',
    'fill_in',
    E'Fig. 3.1 shows the apparatus used to investigate **anaerobic respiration** in yeast. The setup uses yeast in glucose solution with an oil layer on top, connected to a tube of lime water.\n\n**(a)(ii)** Give a reason why the **5 g of glucose** is put in **warm water** in a test-tube and **shaken**.',
    '/past-papers/biology-nssco-2023-p3/yeast-apparatus.png',
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'to dissolve glucose',
  ...
  insert into public.past_paper_questions (
    ...
    jsonb_build_object(
      ...
      'to prevent any oxygen present in the air from dissolving in the sugar solution',
        ...
        'stops oxygen entering the solution',
        'prevent oxygen entering'
    )
, 'must_contain', jsonb_build_array('oxygen')
    ),
    false,
    E'To prevent oxygen from the air dissolving in the sugar solution; [1 mark]\n\n**Examiner commentary:** Many candidates didn''t connect the oil layer to keeping oxygen out — they instead linked it to other roles (emulsification etc.).',
    E'**Oil floats on top of water** and forms a barrier.\n\nThe whole point of this experiment is **ANAEROBIC** respiration (NO oxygen). If oxygen from the air dissolves into the glucose solution:\n• Yeast would do AEROBIC respiration instead → different products (CO₂ + water + lots of ATP)\n• You''d get the wrong result — the experiment is invalid\n\nThe **oil layer prevents oxygen from dissolving** into the sugar solution → yeast is forced to respire anaerobically.',
    true
  );

  -- ─── Q3(a)(iv)  [1 mark, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '3(a)(iv)', 1, 'free',
    'fill_in',
    E'Fig. 3.1 shows the apparatus used to investigate **anaerobic respiration** in yeast. The setup uses yeast in glucose solution with an oil layer on top, connected to a tube of lime water.\n\n**(a)(iv)** Give a reason why the **rubber stopper** must be **sealed properly**.',
    '/past-papers/biology-nssco-2023-p3/yeast-apparatus.png',
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'to prevent oxygen from entering',
        'to prevent oxygen entering the test-tube',
        'stop oxygen entering',
        'keep oxygen out',
        'prevents oxygen entry',
        'to stop air entering'
    )
, 'must_contain', jsonb_build_array('oxygen')
    ),
    false,
    E'To prevent oxygen from entering (the test-tube); [1 mark]\n\n**Examiner commentary:** Many centres failed to introduce this investigation to candidates.',
    E'Same logic as the oil layer — **keep oxygen out**.\n\nThe rubber stopper seals the top of the apparatus. If it''s loose, air (containing oxygen) leaks in → yeast switches to aerobic respiration → experiment ruined.\n\nIt also ensures any gas the yeast produces (CO₂) **only escapes through the delivery tube into the lime water** — so you can detect it.',
    true
  );

  -- ─── Q3(b)  [2 marks, paid, free_text] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, memo, rubric, explanation, is_published
  ) values (
    bio_id, 2023, '3', '3(b)', 2, 'paid',
    'free_text',
    E'Fig. 3.1 shows the apparatus used to investigate **anaerobic respiration** in yeast. The setup uses yeast in glucose solution with an oil layer on top, connected to a tube of lime water.\n\n**(b)** After a few hours the **lime water turned milky**. Explain a conclusion for that observation.',
    '/past-papers/biology-nssco-2023-p3/yeast-apparatus.png',
    E'Both required (1 mark each):\n1. Carbon dioxide is produced;\n2. During anaerobic respiration (by yeast);\n\n**Examiner commentary:** Disappointing — candidates couldn''t connect the observation to the investigation. Some linked lime water turning milky to emulsification (because of the oil layer).',
    E'Award 1 mark for naming CARBON DIOXIDE as the gas produced AND 1 mark for linking it to ANAEROBIC respiration in YEAST. PENALISE: emulsification (wrong — that''s why oil is there, not lime water); aerobic respiration (the oil/seal prevents O₂).',
    E'**Lime water test for CO₂:**\n• Clear → milky white = **carbon dioxide is present**\n\nIn this apparatus:\n• Yeast is using glucose with NO oxygen (because of oil + seal)\n• So yeast does **ANAEROBIC respiration**: glucose → ethanol (alcohol) + **CO₂** + a little energy\n• The CO₂ produced bubbles through the delivery tube into the lime water → turns it milky\n\n**Conclusion: CO₂ is produced by yeast during anaerobic respiration.** Write BOTH halves.',
    true
  );
...
, 'must_contain', jsonb_build_array('phenol')
  ...
  insert into public.past_paper_questions (
    ...
    false,
    E'Add lemon juice / put in water; [1 mark — must include HOW to apply it]\n\n**Examiner commentary:** Many candidates mentioned correct substances but lost the mark by writing ''use'' instead of ''put in'' or ''add''. The instruction must specify the action.',
    E'Two simple kitchen methods that prevent browning:\n\n• **Add lemon juice** — lemon juice is acidic (pH ~2). It denatures the polyphenol oxidase enzyme so it can''t act on the phenol.\n• **Put the apples in water** — submerging the apple in water blocks oxygen from reaching the cut surface. The enzyme needs O₂ to do the browning reaction.\n\n⚠ Don''t just say ''lemon juice'' or ''water'' — say what to DO with it: ''add'', ''put in'', ''soak in'', ''apply''. Vague words lose the mark.',
    true
  );

  -- ─── Q4(a)(iv)  [1 mark, free, fill_in] ───
  insert into public.past_paper_questions (
    subject_id, paper_year, paper_no, q_number, marks, tier,
    type, prompt, diagram_url, correct, case_sensitive,
    memo, explanation, is_published
  ) values (
    bio_id, 2023, '3', '4(a)(iv)', 1, 'free',
    'fill_in',
    E'Peeled apples turn brown when exposed to air as shown in Fig. 4.1.\n\nThis browning is caused by an enzyme called **polyphenol oxidase** which acts on phenol compounds in the apple. This causes the apple to change from white → light brown → dark brown. Polyphenol oxidase can be affected by temperature and pH.\n\n**Table 4.1** — results after 12 minutes\n\n| tube | phenol / cm³ | apple extract / cm³ | acid / cm³ | alkali / cm³ | appearance |\n|---|---|---|---|---|---|\n| 1 | 2.5 | 2.5 | – | – | dark brown |\n| 2 | 2.5 | 2.5 | 3 | – | white |\n| 3 | 2.5 | 2.5 | – | 3 | light brown |\n| 4 | 2.5 | 2.5 | 5.5 | – | white |\n| 5 | 2.5 | 2.5 (boiled) | 3 | – | white |\n\n**(a)(iv)** Under which **pH conditions** does the enzyme work best?',
    '/past-papers/biology-nssco-2023-p3/apples-browning.png',
    jsonb_build_object(
      'accepted', jsonb_build_array(
      'neutral',
